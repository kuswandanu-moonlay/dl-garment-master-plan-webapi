    ...
    router.get("/", passport, function (request, response, next) {
        ...
        getManager(user)
            .then((manager) => {
                ...
                return BookingOrderManager.getCanceledBookingOrderReport(query,request.timezoneOffset);
            })
            .then(docs => {
            ...
            .then((result) => {
                if ((request.headers.accept || '').toString().indexOf("application/xls") < 0) {
                    ...
                    BookingOrderManager.getCanceledBookingOrderReportXls(result, query)
                        .then(xls => {
